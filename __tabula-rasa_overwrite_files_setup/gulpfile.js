...
var projectURL              = 'localhost/theorthodoxfaith.com'; // Project URL. Could be something like localhost:8888.
...
// Style related.
var styleSRC                = './_dev/css/sass/style.scss'; // Path to main .scss file.
var styleDestination        = './css/'; // Path to place the compiled CSS file.
// Defualt set to root folder.

// JS Vendor related.
var jsVendorSRC             = './_dev/js/vendor/*.js'; // Path to JS vendor folder.
var jsVendorDestination     = './js/'; // Path to place the compiled JS vendors file.
var jsVendorFile            = 'vendors'; // Compiled JS vendors file name.
// Default set to vendors i.e. vendors.js.

// JS Custom related.
var jsCustomSRC             = './_dev/js/custom/*.js'; // Path to JS custom scripts folder.
...
// Watch files paths.
var styleWatchFiles         = './_dev/css/sass/**/*.scss'; // Path to all *.scss files inside css folder and inside them.
var vendorJSWatchFiles      = './_dev/js/vendor/*.js'; // Path to all vendor JS files.
var customJSWatchFiles      = './_dev/js/custom/*.js'; // Path to all custom JS files.
...
gulp.task('tr-js', function() {
		...
		//return del(['js/*.js', '!js/customizer.js']);
