 ...
 * @return array
 */
function new_tabula_rasa_page_menu_args( $args ) {
	$args['show_home'] = true;
	return $args;
}
add_filter( 'wp_page_menu_args', 'new_tabula_rasa_page_menu_args' );
 ...
 * @return void
 */
function new_tabula_rasa_setup_author() {
	global $wp_query;
...
add_action( 'wp', 'new_tabula_rasa_setup_author' );
